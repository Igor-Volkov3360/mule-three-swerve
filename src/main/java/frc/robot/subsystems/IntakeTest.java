...
public class IntakeTest extends SubsystemBase {
  ...
  private static final double kNativeToRad = Math.PI / 13.5 / 2;
  private static final double kNominalVolt = 10.0;

  private static final double kNeutralRad = Math.toRadians(0.0);
  private static final double kHorizontalPercent = 0.05;

  private static final double kTargetTolRad = Math.toRadians(5.0);
  private static final double kP = 4.0; // have to continue tweaking
  private static final double kI = 0.0;
  private static final double kD = 0.0;

  private static final double kAngVelRad = Math.toRadians(20.0); // used to be 45
  private static final double kAngAccRed = Math.toRadians(10.0); // used to be 90
  ...
  public void periodic() {
    ...
    m_pidRight.setReference(
        ...
        ControlType.kSmartMotion,
        0,
        this.computeFeedForward(m_encoderRight.getPosition()),
        ArbFFUnits.kPercentOut);
